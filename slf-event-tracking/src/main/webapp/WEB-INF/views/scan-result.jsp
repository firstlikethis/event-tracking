...
<head>
    ...
    <title>ผลการสแกน - SLF Event Tracking</title>
    <!-- Tailwind CSS -->
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            %>
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 mt-4">สแกนสำเร็จ!</h1>
                </div>
                
                <div class="mb-6 p-4 bg-gray-50 rounded-md">
                    <h2 class="font-semibold text-lg mb-2">รายละเอียด:</h2>
                    <p class="mb-2"><span class="font-medium">บูธ:</span> <%= booth.getBoothName() %></p>
                    <p class="mb-2"><span class="font-medium">คำอธิบาย:</span> <%= booth.getBoothDescription() %></p>
                    <p class="text-green-600 font-bold">คุณได้รับ <%= booth.getPoints() %> คะแนน</p>
                </div>
            <% } else { %>
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 mt-4">สแกนไม่สำเร็จ</h1>
                </div>
            ...
            <div class="flex space-x-4">
                <a href="${pageContext.request.contextPath}/scan-qr" class="flex-1 py-3 px-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md text-center">
                    สแกนอีกครั้ง
                </a>
